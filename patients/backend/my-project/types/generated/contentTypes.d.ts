...
export interface ApiDoctorDoctor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    StartTime: Attribute.Time &
      Attribute.Required &
      Attribute.DefaultTo<'10:00'>;
    EndTime: Attribute.Time & Attribute.Required & Attribute.DefaultTo<'17:00'>;
    Profile: Attribute.RichText &
      Attribute.Required &
      Attribute.DefaultTo<'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sagittis id odio sed maximus. Pellentesque ac turpis ut mi porttitor.'>;
    category: Attribute.Relation<
      'api::doctor.doctor',
      'manyToOne',
      'api::category.category'
    >;
    ContactDetails: Attribute.String & Attribute.Required;
